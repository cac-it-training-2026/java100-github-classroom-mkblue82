...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		// int型にキャストして配合率(売上比)を出力
		System.out.println("シトロンの味　　・・・　" + (int) citronPer + "%");
		System.out.println("ショコラの味　　・・・　" + (int) chocolatPer + "%");
		System.out.println("ピスターシュの味・・・　" + (int) pistachioPer + "%");

		System.out.println("\nが楽しめます！\n");

		// マカロンの価格を計算して出力を行う
		int macaronPrice = totalPrice / (int) totalNum / 10 * 10;
		System.out.println("値段は\\" + macaronPrice + "です。");
	}
}
